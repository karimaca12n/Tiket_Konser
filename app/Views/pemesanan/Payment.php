...
<main class="max-w-2xl mx-auto px-6 py-12">
    <!-- Back Button -->
    <a href="/pesanan-saya" class="inline-flex items-center gap-2 text-slate-400 hover:text-primary transition-colors mb-8">
    ...
    <div class="bg-slate-800 rounded-2xl border border-slate-700 p-8 md:p-12">
        <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Pembayaran Tiket</h1>
        <p class="text-slate-400 mb-8">Selesaikan pembayaran untuk mengkonfirmasi pesanan Anda</p>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8 border border-slate-700 space-y-3">
            ...
            <div class="flex justify-between">
                ...
                <span class="font-semibold text-white"><?= $pesanan['jumlah_tiket'] ?> tiket</span>
            </div>
            <div class="flex justify-between pt-3 border-t border-slate-700 text-lg">
                <span class="text-slate-300">Total Pembayaran</span>
